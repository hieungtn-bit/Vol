...
import { BT_WINDOW, blindDerivatives, simulate, type BTOptions, type SimContext, type Trade } from './backtest';
...
export function recToCall(r: Recommendation): DirectionalCall | null {
  ...
  return {
    ...
    rr1: r.rr1, rr2: r.rr2, rewardRatio: null, expectancy: null,
